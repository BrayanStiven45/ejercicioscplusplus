...
int main(){
											...
											if(mes==10){
												...
												if(mes==11){
													...
													cout<<"El numero corresponde al mes de Diciembre";
														...
														cout<<"El numero no corresponde a nungun mes del año";
													}
												}
											}
										}
	...
	if(pro==19){
		int _191, _192, _193;
		cout << "Digite el primer nÃºmero: ";
		cin >> _191;
		cout << "Digite el segundo nÃºmero: ";
		cin >> _192;
		cout << "Digite el tercer nÃºmero: ";
		cin >> _193;
		if((_191*_192)==_193){
			cout << "El tercero es igual a la multiplicaciÃ³n de los otros dos";
		}else{
			cout << "El tercero no es igual a la multiplicaciÃ³n de los otros dos";		
		}
	}
	...
	if(pro==20){
		...
		cin >> _203;
		if((_201%_202)==_203){
			cout << "El tercero es igual al resto de la divisiÃ³n de los otros dos";
		}else{
			cout << "El tercero no es igual al resto de la divisiÃ³n de los otros dos";
		}
	}
	...
	if(pro==21){
		...
		if(_21x==1){
			...
			cin >> _21x;
			cout << "El perÃ­metro del triangulo es igual a " << _21x*3 ;
		} else 
			if (_21x==2){
